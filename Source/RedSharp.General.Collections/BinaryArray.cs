...
namespace RedSharp.General.Collections
{
    public class BinaryArray : IEnumerable<byte>
    {
        ...
        private void ThrowIfIncorrectBitCount(int bitCount)
        {
            switch (bitCount)
            {
                ...
                case 8:
                    return;
                default:
                    throw new ArgumentOutOfRangeException(nameof(bitCount), Resource.Exception_IncompatibleBitCount);
            }
        }
        ...
        private byte Get(int index)
        {
            ...
            NumericGuard.ThrowIfGreaterOrEqual(index, Length, nameof(index));
        ...
        private void Set(int index, byte value)
        {
            ...
            if (value > _maxValues[BitCount])
                throw new ArgumentOutOfRangeException(nameof(value), Resource.Exception_IncompatibleValueForBitCount);
